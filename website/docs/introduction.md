...
JSON API is an open source data source plugin for Grafarg that lets you visualize data from any URL that returns JSON, such as REST APIs or static file servers.
